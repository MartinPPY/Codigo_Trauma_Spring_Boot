# Codigo Trauma Backend

Este es el servicio REST que interactuara con la base de datos PostgreSQL y se encargara de manejar las peticiones del frontend
ademas este repositorio contiene el script.sql que servira como guia al usuario para que pueda crear la base de datos.

ademas esta una plantilla de como deben de ser las variables de entorno
